...
if __name__ == "__main__":
    ...
    big_values_col = ['Total volume', 'Number of vertices', 'Number of faces',
                      'Number of edges', 'Total area',
                      'Maximum aspect ratio', 'Minimum altitude']
    ...
    print(out_df.rename(columns=dict(zip(out_df.keys(), ["A", "B", "C", "D", "E", "F"]))).to_latex())
